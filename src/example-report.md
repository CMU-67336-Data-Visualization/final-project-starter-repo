...
---
<!-- This is the title that appears in the sidebar. If not specified, it defaults to the first heading level 1.-->

<!-- This is a heading level 1 - the more hashtags/levels there are, the smaller headings are -->
...
<!-- End of embedded visualization -->

<!-- This a heading level 3 -->
### Sputnik 1 (1957)
